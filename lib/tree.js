(function() {
  ...
  Tree = (function(_super) {
        ...
        $.ajax({
          ...
          success: (function(_this) {
            return function(result) {
              return _this.createTree(_this.tree, result, _this.opts.onNodeRender);
            };
          })(this)
        });
      } else {
        this.createTree(this.tree, this.opts.items, this.opts.onNodeRender);
      }
    ...
    Tree.prototype.createTree = function($list, items, callback) {
      ...
      for (_i = 0, _len = items.length; _i < _len; _i++) {
        ...
        if ($.isFunction(callback)) {
          callback.call(this, $nodeEl, item);
        }
        if (item.children) {
