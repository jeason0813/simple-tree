(function() {
  ...
  Tree = (function(_super) {
    ...
    Tree.prototype._bind = function() {
      return this.tree.find(".folder").on("click.simple-tree", (function(_this) {
        return function(e) {
          ...
          if (target.is(".fa") && !folder.is(".empty")) {
            treeEl.toggle();
            return folder.find(".fa-caret-down, .fa-caret-right").toggleClass("fa-caret-down").toggleClass("fa-caret-right").end().find(".fa-folder-open-o, .fa-folder-o").toggleClass("fa-folder-open-o").toggleClass("fa-folder-o");
          } else {
    ...
    Tree.prototype._unbind = function() {
      return this.tree.find(".folder").off(".simple-popover");
    };
