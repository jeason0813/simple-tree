(function() {
  ...
  Tree = (function(_super) {
    ...
    Tree.prototype._render = function() {
      ...
      this.tree = $(Tree._tpl.list).addClass('tree').appendTo(this.el);
      if (this.opts.url) {
        $.ajax({
          url: this.opts.url,
          type: "get",
          ...
          success: (function(_this) {
            return function(result) {
              return _this._renderTree(_this.tree, result);
            };
          })(this)
        });
      } else {
    ...
    Tree.prototype._renderTree = function($list, items) {
      ...
      for (_i = 0, _len = items.length; _i < _len; _i++) {
        ...
        if (item[this.properties.children]) {
          ...
          if (expand && isArray) {
            $nodeEl.addClass('expand').find(".toggle").addClass("fa-caret-down");
          } else {
    ...
    Tree.prototype._bind = function() {
      this.tree.on("click.simple-tree", ".node .toggle", (function(_this) {
        return function(e) {
          ...
          $toggle.toggleClass('fa-caret-right').toggleClass('fa-caret-down');
    ...
    Tree.prototype.select = function($node) {
      if ($node) {
        ...
        this.tree.trigger("nodeselected", [$node, $node.data("node")]);
      } else {
